...
const poemsData = [
    {
        ...
        desc: "Безусловная любовь и память о нашей невероятной судьбоносной встрече.",
        icon: "🌹"
    },
    {
        ...
        desc: "Признание, которое я доверил даже ветру. О твоей неземной красоте.",
        icon: "🌬️"
    },
    {
        ...
        desc: "Теплое ожидание нашей встречи. Скоро всё снова будет как прежде.",
        icon: "⏳"
    },
    {
    ...
    },
    {
        ...
        desc: "О нашей первой встрече, волшебстве твоих глаз и том самом месте.",
        icon: "🏠"
    }
];
